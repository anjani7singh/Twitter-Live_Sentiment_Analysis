...
app.layout = html.Div(
    ...
    [   html.Div(className='container-fluid', children=[html.H2('Live Twitter Sentiment', style={'color':"#CECECE","textAlign":"center"}),
        ...
        html.Div(className='container-fluid', children=[html.H5('Window:', style={'color':app_colors['text'], 'margin-top':0, 'margin-bottom': 0}),
                                                        html.Div(className='row', children =
                                                                            [dcc.Input(id='window', value=str(gvalue), type='text',
                                                                                ...
                                                                                html.Div(id='output-container-button',children='Enter a value and press submit',style={'color':"#CECECE"})
                                                                            ]
                                                                         ),
                                                          ],
                         style={'width':'98%','margin-left':15,'margin-right':15,'max-width':50000}
